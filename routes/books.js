...
Router.get("/createBookDirectory", (req, res) => {
  let sql =
...
Router.get("/addBooks/:bookName/:authorName", (req, res) => {
  ...
  mySqlConnection.query(sql, [value], (err) => {
    if (err) {
      throw err;
    }
...
Router.get("/updateBooks/:id/:name", (req, res) => {
